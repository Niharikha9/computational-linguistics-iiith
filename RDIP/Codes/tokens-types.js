...
function dropdown(){
	...
	document.getElementById("demo3").innerHTML="<table border='1' style='border-collapse:collapse'><tr><td>#Tokens</td><td><input type ='number' id='token'></td></tr><tr><td>#Types</td><td><input type ='number' id='type'></td></tr></table>";
	document.getElementById("demo4").innerHTML="<input type='submit'>"
	if(s=="corpus1"){
